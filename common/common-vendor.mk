...
PRODUCT_PROPERTY_OVERRIDES += ro.config.calibration_cad=/system/etc/calibration_cad.xml

PRODUCT_COPY_FILES += \
    vendor/gapps/common/proprietary/etc/calibration_cad.xml:system/etc/calibration_cad.xml \
